    ...
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        <h1 className="text-6xl font-bold text-white">
          Hi, I'm <span className="text-designColor capitalize">Aniket Tembhurne</span>
        </h1>
        ...
        "I am a passionate MERN stack developer . With a strong foundation in web development and a keen eye for data, 
